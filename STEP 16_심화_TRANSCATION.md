...
### 1. 검증과 수정을 도메인별로 분리하는 방안 채택
  - 모듈을 분리하여 이벤트 이미터로 제어 시 해당 트랜잭션에 대한 최종 실패에 대한 구현 난이도 상승

## 결재 완료 후 외부 API로 통신하는 기능에 대한 PR 
  - https://github.com/durara021/hhplus-concert-ticketing/pull/18/commits/d611f89eeb120cadb4ad3661b65bdda5a3993a0c
